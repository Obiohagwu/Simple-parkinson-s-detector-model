...
#Now we can proceed to scale our feature dataset.We will normailze the feature dataset to a range [-1,1]

scaler = MinMaxScaler((-1,1))
x = scaler.fit_transform(features)
y = labels

#Now we can split the datasets into train and test.#We should keep 20% for testing
...
#Then we finally proceed to get y_pred. y_pred is the predicted value for our feature testset
